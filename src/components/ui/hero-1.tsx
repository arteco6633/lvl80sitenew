...
const heroCards = [
  ...
  {
    title: "GEO/AI",
    text: "Сайт, который попадает в ответы GPT, Алисы и AI поиска и становится дополнительным каналом обращений.",
  },
  {
    title: "UI/UX",
    text: "Сайт с продуманной логикой, сценарием и дизайном, который доведёт пользователя до целевого действия.",
  },
]
